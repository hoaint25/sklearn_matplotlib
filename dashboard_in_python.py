...
from dash.dependencies import JupyterDash 
import plotly.graph_objects as go 
import plotly.express as px
from dash import no_update   


#create a dash applications 
app = JupyterDash(__name__)
JupyterDash.infer_jupyter_proxy_config()

#review 1: clear the layout anf do not display exception till call back 
...
#list of years 
year_list = [i for i in range 82005, 2021, 1)]
